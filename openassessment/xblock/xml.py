...
def serialize_content_to_xml(oa_block, root):
    ...
    if oa_block.allow_multiple_files is not None:
        root.set('allow_multiple_files', six.text_type(oa_block.allow_multiple_files))
...
def parse_from_xml(root):
    ...
    if 'allow_multiple_files' in root.attrib:
        allow_multiple_files = _parse_boolean(six.text_type(root.attrib['allow_multiple_files']))
